...
class View:
    ...
    def getMaxInDatasourceDict(self, gene):
        # overall max signal across all datasources
        overallMax = 0
        maxDatasource = ''
        output = {}
    ...
    def createGene(self, geneId, probesetId, geneAlias):
        return efpDb.Gene(geneId, self.database, probesetId, geneAlias)
...
class View_dev (View):
    ...
    def createGene(self, geneId, probesetId, geneAlias):
        return efpDb.Gene_ATX(geneId, probesetId, geneAlias)
